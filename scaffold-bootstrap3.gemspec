...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "activesupport", [">= 3.1", "< 4.1.1"]
  spec.add_dependency "actionpack", [">= 3.1", "< 4.1.1"]
  spec.add_dependency "railties", [">= 3.1", "< 4.1.1"]

  spec.add_development_dependency "rails", [">= 3.1", "< 4.1.1"]
